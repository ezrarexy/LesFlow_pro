        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalAddLabel">Tambah Bengkel</h1>
                ...
                <div class="modal-body">
                    <form id="form1">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control border" name="alamat" id="iAlamat"/>
                        </div>
                        <div class="mb-3">
                            <label for="iJenis">Jenis</label>
                            <select class="form-select border" name="id_jenis_bengkel" id="iJenis">
